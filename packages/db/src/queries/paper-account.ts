...
interface PortfolioState {
 ...
 readonly openPositions: readonly { readonly tokenId: string; readonly notional: Money }[];
 readonly realizedTodayPnl: Money;
 readonly consecutiveLosses: number;
}

/** Virtual starting balance shared by worker and dashboard. */
export const PAPER_INITIAL_CASH = money(300000n, "EUR");
...
export async function readPaperAccount(input: Parameters<typeof loadPaperAccount>[0]): Promise<PaperAccount> {
